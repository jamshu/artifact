...
class ScrapReportXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        worksheet.set_column('G:G', 25)  # Reason
        worksheet.set_column('H:H', 30)  # Remarks
        
        current_row = 0
        
        # Write report title
        worksheet.merge_range(current_row, 0, current_row, 7, 'Scrap Report', title_format)
        current_row += 1
        
        # Write filter summary
        worksheet.write(current_row, 0, 'Date Range:', filter_label_format)
        worksheet.merge_range(current_row, 1, current_row, 7, 
        ...
        worksheet.merge_range(current_row, 1, current_row, 7, warehouse_names, filter_value_format)
        current_row += 1
        ...
        if wizard.location_ids:
            ...
            worksheet.merge_range(current_row, 1, current_row, 7, location_names, filter_value_format)
            current_row += 1
        ...
        if wizard.operation_type_ids:
            ...
            worksheet.merge_range(current_row, 1, current_row, 7, operation_names, filter_value_format)
            current_row += 1
        ...
        if wizard.category_ids:
            ...
            worksheet.merge_range(current_row, 1, current_row, 7, category_names, filter_value_format)
            current_row += 1
        ...
        if wizard.product_ids:
            ...
            worksheet.merge_range(current_row, 1, current_row, 7, product_names, filter_value_format)
            current_row += 1
        ...
        for line in report_data:
            ...
            worksheet.write(current_row, 6, line['reason'], cell_format)
            worksheet.write(current_row, 7, line['remarks'], cell_format)
            current_row += 1
